...
#@export var points = 0;
#
#@onready var ENEMY_SHIP = preload("res://objects/ships/scenes/enemys_ship.tscn");
#@onready var PLAYER_SHIP = load("res://scenes/minigames/cannon_minigame/scripts/cannon_player.gd")
#
